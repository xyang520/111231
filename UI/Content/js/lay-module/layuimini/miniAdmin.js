        ...
        render: function (options) {
            ...
            $.getJSON(options.iniUrl, function (data) {
                if (data == null) {
                    ...
                    miniAdmin.renderLogo(jsondata.logoInfo);
                    miniAdmin.renderClear(jsondata.clearUrl);
                    miniAdmin.renderHome(jsondata.homeInfo);
                    miniAdmin.renderAnim(jsondata.pageAnim);
                    miniAdmin.listen();
                    miniMenu.render({
                        menuList: jsondata.menuInfo,
